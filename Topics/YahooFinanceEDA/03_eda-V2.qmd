...
subtitle: "A reproducible EDA built from a static universe and the latest market-data snapshot"
author: "Mike Aguilar"
date: today
format:
  html:
...
The full listed-security universe is used in this module. Counts therefore include common stocks, ADRs, ETFs, preferred securities, warrants, rights, units, funds, and other listings retained by the static universe build.
...
#| fig-width: 12
#| fig-height: 10
#| fig-cap: "Listed-security counts by exchange, inferred security type, and static S&P 500 membership."

# Purpose:
#   Visualize how the broad listed universe is distributed across exchanges,
#   security types, and benchmark membership.
# Inputs:
#   module1_detail_summary created in the preceding chunk.
# Outputs:
#   A faceted stacked bar chart with S&P 500 constituents highlighted.
...
module1_plot <- ggplot(
  ...
  labs(
    ...
    subtitle = paste0(
      "Counts use the static exchange snapshot as of ",
      universe_as_of,
